...
* 의제 목록
    ...
    * 의제 4: pigma 확인
* 의제별 논의 요지  
    * 의제 1: 시나리오 별 제공이 아닌, 가장 적합할 것 같은 상황 한 가지만 제시
    * 의제 2: 농사를 짓는 데에 생산량도 중요하지만 땅값도 충분히 고려해봐야 하는 요소임. -> API를 활용해 반환 가능한지 확인함
    * 의제 3: 발표 ppt 제작
    * 의제 4: 지역에 숫자로 생산량을 띄우는 것이 아닌, 한 눈에 알아볼 수 있게 색깔로 시각화하기로 함.
* 공유사항 및 차기 회의 일정
    * 5/12 비대면 중간 발표 전 최종 회의
...
* 참석자: 이현종, 임형준, 이건희
* 의제 목록
    * 의제 1: 블록 다이어그램, 시퀀스 다이어그램 제작
    * 의제 2: ERRC 방식으로 선행 기술과의 차이점 설명
    * 의제 3: 중간발표 ppt 완성
    * 의제 4: pigma 확인
* 의제별 논의 요지  
    * 의제 1: 구체적 다이어그램 제작
    * 의제 2: ERRC 관점으로 선행 기술과의 차이점과 현재 진행하는 프로젝트의 장점 설명
    * 의제 3: 발표 ppt 완성
    * 의제 4: 이전의 pigma 수정 사항 관련 피드백
* 공유사항 및 차기 회의 일정
    * 5/13 중간 발표 이후 회의 예정
...
* 의제 목록
    ...
    * 의제 2: 역할 조정 및 세부화
* 의제별 논의 요지  
    * 의제 1: 각 역할과 일정에 따른 개발 내용 회의
    * 의제 2: Django 이용한 개발 초기 단계에서 일정에 맞는 구현 계획 구체화 
* 액션 아이템
    * 메인페이지 지도 구현
    * Django 초기 환경 세팅 및 공유
    * 지도 표현 툴 탐색
* 공유사항 및 차기 회의 일정
    * 5/15일 공휴일로 5/20까지 역할에 맞는 파트 구현 및 통합 예정
...
* 의제 목록
    ...
    * 의제 2: DB 이용 논의
* 의제별 논의 요지  
    * 의제 1: Django 프로젝트 통합. 역할별 수행한 프론트 디자인, 행정구역별 분리, 위도와 경도 데이터 확인, db와 연결 부분 통합
    * 의제 2: 처음 계획한 mongoDB 대신 Django 내부 db.sqlite 사용 가능성 논의하여 db.sqlite 사용하기로 결정
* 액션 아이템
    * 계획된 기능 수행 가능한 지도 툴 (Qgis, Leaflet, googleMap ) 재탐색
    * 지도에서 기능 구현(이슈관리 통한 관리)
    * 역할 및 일정 별 개발 진행
* 공유사항 및 차기 회의 일정
    * 5/24 비대면 회의
...
* 의제 목록
    ...
    * 의제 2: DB 이용한 데이터 삽입
* 의제별 논의 요지  
    * 의제 1: 지도 내 행정 구역 분리, 선택 내용 정리하여 통합, 공시지가 api 이용한 이미지 통합, 팝업 형태로 제작
    * 의제 2: 작물 별 파일 관리 --> 통합 파일로 관리
* 액션 아이템
    * 문서 관리
    * 검토내용 반영하여 개선사향 확인
...
* 의제별 논의 요지  
    * 의제 1: 서버 및 배포방법 선정
    * 의제 2: readme.md, overview.md의 문서관리 및 내용 구성
* 액션 아이템
    * 문서 관리
...
* 의제 목록
    ...
    * 의제 2: 프로젝트 페이지 최종 점검
* 의제별 논의 요지  
    * 의제 1: readme.md, overview.md의 문서관리 및 내용 구성, 유스케이스, 블록다이어그램, 시스템다이어그램 재구성
    * 의제 2: 프로젝트 최종 점검 및 서버 확인
* 액션 아이템
    * 최종보고서 작성
    * 최종발표자료 준비
* 공유사항 및 차기 회의 일정
